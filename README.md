...
[![Java CI](https://github.com/thriving-dev-test/github-meetup-ffm/actions/workflows/1.pipeline.yml/badge.svg)](https://github.com/thriving-dev-test/github-meetup-ffm/actions/workflows/1.pipeline.yml)
...
[![Javadoc](https://img.shields.io/badge/JavaDoc-Online-green)](https://thriving-dev-test.github.io/github-meetup-ffm/javadoc/)
...
## CI/CD Pipeline
The heart of this template is the ['Main GitHub Actions CI/CD Pipeline'](https://github.com/thriving-dev-test/github-meetup-ffm/actions/workflows/1.pipeline.yml).
...
Please define the secrets via your repository settings. ([Settings > Security > Secrets and variables > Actions](https://github.com/thriving-dev-test/github-meetup-ffm/settings/secrets/actions))
...
To host the generated Javadoc, configure GitHub Pages for your repository to deploy from branch `gh-pages`. You can also find all deployments under ['pages-build-deployment'](https://github.com/thriving-dev-test/github-meetup-ffm/actions/workflows/pages/pages-build-deployment).
